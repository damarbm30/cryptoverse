...
const CryptoDetails = () => {
  ...
  const stats = [
    ...
    {
      title: "All-time-high (daily average)",
  ...
  return (
    <Col className="coin-detail-container">
      <Col className="coin-heading-container">
        ...
        <p>{cryptoDetails?.name} live price in USD. View value statistics, market cap and supply.</p>
      </Col>
      <Select
        defaultValue={"7d"}
      ...
      <Col className="coin-desc-link">
        <Row className="coin-desc">
          ...
          <Text>{cryptoDetails ? HTMLReactParser(cryptoDetails?.description) : ""}</Text>
        </Row>
